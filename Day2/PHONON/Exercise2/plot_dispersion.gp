...
set xrange [0:3.7802]
set yrange [0:430]
set arrow from 1.0607,0. to 1.0607,450 nohead  lw 3
set arrow from 1.4142,0. to 1.4142,450 nohead  lw 3
set arrow from 1.9142,0. to 1.9142,450 nohead  lw 3
set arrow from 2.9142,0. to 2.9142,450 nohead  lw 3
set arrow from 3.7802,0. to 3.7802,420 nohead  lw 3
